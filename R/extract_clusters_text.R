...
#'
#' `r lifecycle::badge('experimental')` As an end user, you mainly want to work
#' with the text from the different detected text clusters. This function
#' combines the text from each cluster into a character string and places it in
#' a Tibble.
#'
...
extract_clusters_text <- function(pdf_data_page_clusters){

  clusters_text <- pdf_data_page_clusters |>
